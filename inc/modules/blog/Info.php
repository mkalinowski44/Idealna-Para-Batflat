...
return [
    ...
    'install'       =>  function () use ($core) {
        $core->db()->pdo()->exec("CREATE TABLE IF NOT EXISTS `blog` (
                        ...
                        `cover_thumbnail`	TEXT DEFAULT NULL,
                        `cover_mobile`	TEXT DEFAULT NULL,
        ...
        $core->db()->pdo()->exec("INSERT INTO `settings`
                    ...
                    VALUES
                    ('blog', 'perpage', '5'),
                    ('blog', 'subjects_perpage', '6'),
                    ('blog', 'disqus', ''),
                    ('blog', 'dateformat', 'M d, Y'),
                    ('blog', 'title', 'Blog'),
                    ('blog', 'subjects_title', 'Tematy'),
                    ('blog', 'desc', '... Why so serious? ...'),
                    ('blog', 'subjects_desc', '... Why so serious? ...'),
                    ('blog', 'latestPostsCount', '5')
                    ('blog', 'popularTagsCount', '10')
        ");
